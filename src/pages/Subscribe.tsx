...
const Subscribe = () => {
    const [createSubscriber, { data, loading }] = useMutation(CREATE_SUBSCRIBER_MUTANTION)
    const [subscriber, setSubsciber] = useState({
        name: "",
        email: ""
    })
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
                        <input
                            ...
                            onChange={event => setSubsciber({ ...subscriber, name: event.target.value })}
                        />
                        <input
                            className="bg-gray-900 rounded px-5 h-14"
                            type="email"
